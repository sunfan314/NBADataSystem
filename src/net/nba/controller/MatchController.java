...
public class MatchController {
	...
	public @ResponseBody List<MatchInfo> getLatestMatchInfos(){
		//获取最近50场比赛的信息
		return matchService.getLatestMatchInfos();
	}
	
	@RequestMapping("/getTeamMatchInfos")
	public @ResponseBody List<MatchInfo> getTeamMatchInfos(int teamId){
		//获取当前赛季某只球队的所有比赛信息
		return matchService.getTeamMatchInfos(teamId);
	}
